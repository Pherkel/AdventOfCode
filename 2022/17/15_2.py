...
pusher = [*open("2022/17/input").readline()]
...
# detect how many stones fall in a cycle and how high that is
p = 0
...
# grid has been determined now finding cylces
first = 50
ls1 = grid[1:first+1][:]

for x in range(first + 1, height-first):
    ...
    if same:
        print(f"Cycle has been found after at height")
        break

# calc 1000000000000 % # of stones in a cylce to get final few drops
# calc 1000000000000 // # of stones * height of a cycle to get height
print(height)
